...
[![Go Report Card](https://goreportcard.com/badge/github.com/fbis251/ynab.go)](https://goreportcard.com/report/github.com/fbis251/ynab.go) [![GoDoc Reference](https://godoc.org/github.com/fbis251/ynab.go?status.svg)](https://godoc.org/github.com/fbis251/ynab.go)
...
```
go get github.com/fbis251/ynab.go
```
...
See the [godoc](https://godoc.org/github.com/fbis251/ynab.go) to see all the available methods with example usage.
